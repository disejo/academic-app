...
const IconComponentEditProfile = ({ direction = 0, path, tooltipText }: Props) => {
  ...
  return (
    <div className="relative flex items-center justify-center">
      ...
      >
        <Icon path={mdiAccountEdit} size={1} color={isActive ? 'white' : 'gray'} />
      </button>
...
export default IconComponentEditProfile;
